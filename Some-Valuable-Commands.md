...
```
sudo docker tag [image id] [account or namespace]/github-actions-runner-debian-12.12:28082026
sudo docker push [account or namespace]/github-actions-runner-debian-12.12:28082026
```
